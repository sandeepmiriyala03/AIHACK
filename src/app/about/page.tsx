    ...
    <>
      ...
      <main className="container">
        <header className="page-header">
          ...
          <p>
            Powerful, easy-to-use OCR platform supporting over 34 languages — upload your images and documents to instantly extract and explore text.
          </p>
        </header>
        <section className="instructions">
          ...
          <p>
            We support over 34 languages, making text extraction from images and documents seamless and versatile—all at your fingertips.
          </p>
          <p>
